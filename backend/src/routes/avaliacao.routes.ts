...
const avaliacaoRoutes = (router: Router) => {
  router.post("/avaliacao", verifyToken, authorize, AvaliacoesController.createAvaliacao);
  router.get("/avaliacao", verifyToken, authorize, AvaliacoesController.getAllAvaliacoes);
