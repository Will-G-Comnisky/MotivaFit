...
-- AddForeignKey
ALTER TABLE "telefone" ADD CONSTRAINT "telefone_id_usuario_fkey" FOREIGN KEY ("id_usuario") REFERENCES "usuario"("id_usuario") ON DELETE NO ACTION ON UPDATE NO ACTION;
