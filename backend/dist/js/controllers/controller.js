...
const respositories_1 = __importDefault(require("../repositories/respositories"));
const repositories = new respositories_1.default();
class Controller {
    ...
    static getTreino(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const treino = yield repositories.getTreinoById(treinoid);
                res.json(treino);
            }
            catch (error) {
